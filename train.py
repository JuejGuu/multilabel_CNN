...
def train_cnn_rnn():
    input_file = "/Users/guu/Desktop/whole.csv"
    x_, y_, vocabulary, vocabulary_inv, df, labels = data_helper.load_data(input_file)

    training_config = '/Users/guu/Downloads/multi-class-text-classification-cnn-rnn-master/training_config.json'
    ...
    trained_dir = '/Users/guu/Downloads/multi-class-text-classification-cnn-rnn-master/trained_results'
    ...
    with graph.as_default():
        ...
        with sess.as_default():
            ...
            checkpoint_dir = '/Users/guu/Downloads/multi-class-text-classification-cnn-rnn-master/checkpoints'
